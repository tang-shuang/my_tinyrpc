...
namespace tinyrpc
{
    ...
    void TcpClient::setTimeout(const int v)
    {
        m_max_timeout = v;
    }

    void TcpClient::setTryCounts(const int v)
    {
        m_try_counts = v;
    }

    const std::string &TcpClient::getErrInfo()
    {
        return m_err_info;
    }

    NetAddress::ptr TcpClient::getPeerAddr() const
    {
        return m_peer_addr;
    }

    NetAddress::ptr TcpClient::getLocalAddr() const
    {
        return m_local_addr;
    }
    
    AbstractCodeC::ptr TcpClient::getCodeC()
    {
        return m_codec;
    }
}